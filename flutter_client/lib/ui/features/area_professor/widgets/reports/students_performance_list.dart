...
class _StudentsPerformanceListState extends State<StudentsPerformanceList> {
        ...
        if (filtered.isEmpty)
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  Icon(Icons.person_search_rounded, size: 54, color: AppColors.primary.withOpacity(0.4)),
  ...
  Widget _buildStudentCard(BuildContext context, AlunoDesempenho aluno) {
    ...
    if (aluno.taxaAproveitamento < 50) barColor = AppColors.error;
    else if (aluno.taxaAproveitamento < 75) barColor = Colors.orange.shade700;
